...
const specs: Spec[] = [
  ...
  {
    label: "AI Model Backbone",
    value: "YOLOv8 Extra-Large + ResNet Classifier",
  },
  {
    label: "Supported Damage Types",
    value: "Scratches, Dents, Cracks, Panel Misalignments",
  },
  { label: "API Protocol", value: "gRPC & REST / JSON Webhooks" },
  {
    label: "Deployment Architecture",
    value: "Docker / Google Cloud Run / GPU-accelerated",
  },
      ...
      <div>
        ...
        <section className="mx-auto max-w-[930px] px-5 pb-[40px] pt-[66px] text-center md:px-6 md:pt-[92px]">
          ...
          <p className="mx-auto max-w-[580px] text-base leading-[1.5] tracking-[-.015em] text-[#b5b3ae] md:text-lg">
            Dentro uses deep neural networks to inspect vehicles, providing
            rental managers, dealers, and fleet operators with objective damage
            classification.
          </p>
        </section>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {specs.map((spec) => (
                  ...
                  >
                    <td className="py-4 px-6 text-[#9d9c97] font-medium">
                      {spec.label}
                    </td>
                    <td className="py-4 px-6 font-mono text-[#e4ff67] text-xs">
                      {spec.value}
                    </td>
                  </tr>
                ))}
