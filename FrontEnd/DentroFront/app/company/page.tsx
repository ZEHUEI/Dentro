      ...
      <div>
        ...
        <section className="mx-auto max-w-[930px] px-5 pb-[40px] pt-[66px] text-center md:px-6 md:pt-[92px]">
          ...
          <p className="mx-auto max-w-[580px] text-base leading-[1.5] tracking-[-.015em] text-[#b5b3ae] md:text-lg">
            Dentro was founded by automotive and artificial intelligence
            engineers who believe that vehicle inspection shouldn&apos;t rely on
            clipboard checklists and subjective eyes.
          </p>
        </section>
        ...
        <section className="mx-auto max-w-[1160px] px-5 py-[50px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((val) => (
              ...
              >
                <div>
                  <h3 className="text-lg font-bold text-[#ecebe7] mb-3">
                    {val.title}
                  </h3>
