      ...
      <div>
        ...
        <section className="mx-auto max-w-[930px] px-5 pb-[40px] pt-[66px] text-center md:px-6 md:pt-[92px]">
          ...
          <p className="mx-auto max-w-[580px] text-base leading-[1.5] tracking-[-.015em] text-[#b5b3ae] md:text-lg">
            Whether managing a peer-to-peer car share fleet, a regional car
            dealership, or thousands of logistics trucks, Dentro integrates
              ...
              >
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    <h2 className="text-2xl font-bold text-[#ecebe7] mb-2">
                      {vert.title}
                    </h2>
                    <p className="text-sm font-medium text-[#b5b3ae] italic mb-4">
                      {vert.subtitle}
                    </p>
                  </div>
                  <div className="flex gap-4 flex-wrap mt-4 md:mt-0">
                    {vert.metrics.map((met) => (
                      <span
                        key={met}
