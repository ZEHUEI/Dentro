...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(ellipse_65%_27%_at_50%_15%,#292928_0%,#1a1a1a_50%,#151515_100%)] font-[Arial,Helvetica,sans-serif] text-[#f1f0ed]">
      <header className="mx-auto flex h-[66px] max-w-[1260px] items-center justify-between px-5 text-sm md:h-[76px] md:px-[30px]">
        <a className="text-[22px] font-semibold tracking-[-1px]" href="#top">
        ...
        <nav className="hidden gap-[29px] text-[#c8c6c1] md:flex">
          ...
          <a className={navLink} href="#solutions">
            Solutions
          </a>
        ...
        <div className="flex items-center gap-5 text-[#cfcdc7]">
          <a className={`hidden md:block ${navLink}`} href="#login">
            Log in
          </a>
          <a
      ...
      >
        ...
        <div className="mt-8 flex items-center justify-center gap-[18px] md:gap-[25px]">
          ...
          <a className="text-sm text-[#d3d1cc]" href="#product">
            See how it works{" "}
      ...
      >
        <div className="flex h-[575px] overflow-hidden rounded-[11px] border border-[#3a3a38] bg-[#202020] shadow-[0_30px_100px_#0008,0_0_0_1px_#ffffff06_inset] md:h-[610px] md:rounded-2xl">
          <aside className="hidden w-[228px] shrink-0 flex-col border-r border-[#292929] bg-[#1a1a1a] p-3 md:flex">
            <a className="px-[7px] pb-[15px]" href="#top">
              <span className="align-[-2px] text-[25px] text-[#e4ff67]">◒</span>
            </a>
            ...
            <div className="mt-7 flex flex-col gap-[3px]">
              ...
              <a
                className="rounded-[5px] bg-[#30302f] p-[9px] text-xs text-[#ecebe7]"
                href="#product"
              >
              ...
              <a
                className="rounded-[5px] p-[9px] text-xs text-[#9d9c97]"
                href="#product"
              >
                2023 Volvo XC60
              </a>
            ...
            <div className="mx-auto w-full max-w-[720px] px-[17px] pt-[38px] pb-5 md:px-[50px] md:pt-[54px] md:pb-[30px]">
              ...
              <div className="mt-[25px] overflow-hidden rounded-[10px] border border-[#3c3c39] bg-[#242423] md:ml-[37px]">
                ...
                <div className="flex justify-between px-[13px] py-[13px] text-[10px] text-[#85837d] md:px-[19px]">
                  ...
                  <a className="text-[#e6e4de]" href="#report">
                    Open full report{" "}
      ...
      <section
        className="mx-auto mt-[100px] max-w-[1160px] px-6 pb-20 md:mt-[150px] md:pb-[110px]"
        id="solutions"
      >
